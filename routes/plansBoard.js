...
const { getItems, getItem, createItem, updateItem, deleteItem } = require('../controllers/plansBoard');
const { validatorCreate, validatorGet, validatorUpdate, validatorDelete } = require('../validators/plansBoard');
