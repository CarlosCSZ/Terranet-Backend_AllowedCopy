...
const { getItems, getItem, createItem, updateItem, deleteItem } = require('../controllers/footerLinks');
const { validatorCreate, validatorUpdate, validatorGet, validatorDelete } = require('../validators/footerLinks');
