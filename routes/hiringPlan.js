...
const { getItems, getItem, createItem, updateItem, deleteItem } = require('../controllers/hiringPlan');
const { validatorCreate, validatorUpdate, validatorGet, validatorDelete } = require('../validators/hiringPlan');
